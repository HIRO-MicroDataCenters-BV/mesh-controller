...
///
/// 1. When no filter is set the default "mesh=INFO" filter will be applied
/// 2. When only a level was given ("INFO", "DEBUG", etc.) it will be used for the mesh target
///    "mesh={level}"
