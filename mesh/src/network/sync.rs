...
// pub struct Digest {
//     pub peer: BTreeMap<PeerId, Version>
// }
...
//         let stream = into_cbor_stream::<Message>(rx);
...
//                 // }
//             }
//             Query::NoSyncResources { public_key } => {
...
//     pub fn new(config: NodeConfig, private_key: PrivateKey, kube_api: KubeApi) -> Self {
//         Self {
//             config,
